...
import com.application.coopcycle.service.PanierQueryService;
...
/**
 * REST controller for managing {@link com.application.coopcycle.domain.Panier}.
 */
@RestController
@RequestMapping("/api")
public class PanierResource {
     ...
     */
    @GetMapping("/paniers")
    public ResponseEntity<List<PanierDTO>> getAllPaniers(PanierCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Paniers by criteria: {}", criteria);
        Page<PanierDTO> page = panierQueryService.findByCriteria(criteria, pageable);
