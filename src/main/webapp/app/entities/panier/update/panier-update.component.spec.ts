  ...
  describe('Panier Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Compte query and add missing value', () => {
        ...
        const madeBy: ICompte = { id: 6813 };
        panier.madeBy = madeBy;

        const compteCollection: ICompte[] = [{ id: 55845 }];
      ...
      it('Should call SystemePaiement query and add missing value', () => {
        const panier: IPanier = { id: 456 };
        const paidBy: ISystemePaiement = { id: 74363 };
        panier.paidBy = paidBy;

        const systemePaiementCollection: ISystemePaiement[] = [{ id: 16600 }];
      ...
      it('Should update editForm', () => {
        const panier: IPanier = { id: 456 };
        const madeBy: ICompte = { id: 20506 };
        panier.madeBy = madeBy;
        const paidBy: ISystemePaiement = { id: 2616 };
        panier.paidBy = paidBy;
