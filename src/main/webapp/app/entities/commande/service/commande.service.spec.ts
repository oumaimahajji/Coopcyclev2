  ...
  describe('Commande Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        id: 0,
        created: currentDate,
        state: EtatCommande.STARTED,
        timeStarted: currentDate,
        timeEnded: currentDate,
      };
    });
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            timeStarted: currentDate.format(DATE_TIME_FORMAT),
            timeEnded: currentDate.format(DATE_TIME_FORMAT),
          },
          elemDefault
        );
      ...
      describe('addCommandeToCollectionIfMissing', () => {
        ...
        it('should add only unique Commande to an array', () => {
          const commandeArray: ICommande[] = [{ id: 123 }, { id: 456 }, { id: 88609 }];
